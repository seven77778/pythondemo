...
def aesEncrypt(text, secKey):
    ...
    print(pad)
    result = pad * chr(pad)
    # print("111 "+urllib.parse.urlencode(chr(pad)).encode(encoding='UTF8'))

    print(text)
    text = text + pad * chr(pad)
    encryptor = AES.new(str.encode(secKey),AES.MODE_ECB)
...
def getSongIdListBy3Party():
    ...
    #
    # if songIdList:
    #     print("抓取到了 " + songIdList)
    # else:
    songIdList = ['晴天','龙拳','演员','蓝莲花']
    return songIdList
